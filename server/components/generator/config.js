...
const getImageConfig = () => {
	const { seed, steps, width, height, cfgScale, samplerName } = baseConfig;
	return {
		seed,
		steps,
		width: width,
...
export { baseConfig, getImageConfig, getVideoConfig, getVideoConfigModified, getVideoConfigOriginal };
